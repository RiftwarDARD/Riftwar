...
Shader "DawnShaderHDRP_V2/EnergyHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord9 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord35 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 VertexOffset81 = ( clampResult62 * max( ( inputMesh.normalOS * _Direction ) , temp_cast_12 ) );
					...
					)
			{
				...
				surfaceDescription.Color = Emiisive82.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				float4 _SpeedConstant = float4(1,-2,2,-1);
				float2 temp_cast_0 = (_SpeedConstant.x).xx;
				float2 texCoord35 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult40 = (float4(_UTilling , _VTilling , 0.0 , 0.0));
				float4 temp_output_41_0 = ( float4( ( texCoord35 * _Tilling ), 0.0 , 0.0 ) * appendResult40 );
				float2 panner10 = ( temp_output_14_0 * temp_cast_0 + temp_output_41_0.xy);
				float2 panner11 = ( temp_output_14_0 * _SpeedConstant.xy + ( temp_output_41_0 + 0.418 ).xy);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord9 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float mulTime16 = _TimeParameters.x * _TimeScale;
				float temp_output_14_0 = ( _Speed * mulTime16 );
				float4 _SpeedConstant = float4(1,-2,2,-1);
				float2 temp_cast_0 = (_SpeedConstant.x).xx;
				float2 texCoord35 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult40 = (float4(_UTilling , _VTilling , 0.0 , 0.0));
				float4 temp_output_41_0 = ( float4( ( texCoord35 * _Tilling ), 0.0 , 0.0 ) * appendResult40 );
				float2 panner10 = ( temp_output_14_0 * temp_cast_0 + temp_output_41_0.xy);
				float2 panner11 = ( temp_output_14_0 * _SpeedConstant.xy + ( temp_output_41_0 + 0.418 ).xy);
			...
			float4 Frag( VertexOutput packedInput , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float4 _SpeedConstant = float4(1,-2,2,-1);
				float2 temp_cast_0 = (_SpeedConstant.x).xx;
				float2 texCoord35 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult40 = (float4(_UTilling , _VTilling , 0.0 , 0.0));
				float4 temp_output_41_0 = ( float4( ( texCoord35 * _Tilling ), 0.0 , 0.0 ) * appendResult40 );
				float2 panner10 = ( temp_output_14_0 * temp_cast_0 + temp_output_41_0.xy);
				float2 panner11 = ( temp_output_14_0 * _SpeedConstant.xy + ( temp_output_41_0 + 0.418 ).xy);
		...
		Pass
		{
					...
					)
			{
				...
				float4 _SpeedConstant = float4(1,-2,2,-1);
				float2 temp_cast_0 = (_SpeedConstant.x).xx;
				float2 texCoord35 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult40 = (float4(_UTilling , _VTilling , 0.0 , 0.0));
				float4 temp_output_41_0 = ( float4( ( texCoord35 * _Tilling ), 0.0 , 0.0 ) * appendResult40 );
				float2 panner10 = ( temp_output_14_0 * temp_cast_0 + temp_output_41_0.xy);
				float2 panner11 = ( temp_output_14_0 * _SpeedConstant.xy + ( temp_output_41_0 + 0.418 ).xy);
...
Node;AmplifyShaderEditor.CommentaryNode;64;-37.08017,-1019.958;Inherit;False;870.2644;323.4664;Fine Tune;5;59;58;61;60;62;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;57;-1653.939,-1022.599;Inherit;False;1571.341;399.7491;Electric Effect;8;54;56;55;53;9;47;44;97;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;42;-4690.74,-1508.289;Inherit;False;657.7256;497.1013;Tilling;7;35;37;36;39;38;40;41;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;34;-3991.793,-1521.044;Inherit;False;2308.569;1226.168;Motion 4 ways Chaos;26;10;11;12;13;14;16;18;19;20;21;22;25;26;27;28;29;30;31;33;17;15;32;24;23;95;98;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;85;673.6964,7.916504;Inherit;False;82;Emiisive;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;86;671.6964,87.9165;Inherit;False;63;Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;87;652.9628,170.4455;Inherit;False;81;VertexOffset;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;935.6411,32.22744;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;DawnShaderHDRP_V2/EnergyHDRP;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638140166367196978;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;638140166536397107;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;638140211031560645;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.PannerNode;10;-2988.801,-1152.909;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;11;-2986.801,-958.9091;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;12;-2997.801,-788.9091;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;13;-2993.801,-619.9091;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-3440.801,-652.9091;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-3762.8,-562.9091;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-3437.801,-1134.909;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-3432.801,-989.9088;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleAddOpNode;20;-3435.801,-845.9091;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-3765.8,-1116.909;Inherit;False;Constant;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;0.418;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;-2687.486,-944.8757;Inherit;True;Property;_TextureSample1;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;27;-2688.486,-733.8757;Inherit;True;Property;_TextureSample2;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;28;-2689.486,-524.8757;Inherit;True;Property;_TextureSample3;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-2327.309,-1008.948;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-2315.486,-590.4152;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;31;-2132.229,-823.3273;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;-4640.74,-1458.289;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;37;-4567.015,-1325.188;Inherit;False;Property;_Tilling;Tilling;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-4388.606,-1457.742;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-4557.015,-1216.188;Inherit;False;Property;_UTilling;U Tilling;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-4557.015,-1127.188;Inherit;False;Property;_VTilling;V Tilling;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;40;-4353.014,-1230.188;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-4195.015,-1458.187;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-2110.947,-521.8422;Inherit;False;Property;_Divisor;Divisor;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;44;-1278.127,-967.7783;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;47;-1603.939,-821.9745;Inherit;True;True;False;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-1581.024,-967.1024;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;53;-1069.261,-972.5991;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-844.2605,-966.5991;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;56;-573.4557,-967.4717;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-1034.261,-829.5991;Inherit;False;Property;_Number;Number;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;24;-2687.801,-1171.913;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-1918.228,-822.145;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-3941.796,-566.9091;Inherit;False;Property;_TimeScale;Time Scale;3;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-3762.8,-968.9091;Inherit;False;Constant;_Float2;Float 2;2;0;Create;True;0;0;0;False;0;False;8.9;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-3772.3,-816.3091;Inherit;False;Constant;_Float3;Float 3;2;0;Create;True;0;0;0;False;0;False;0.65;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;97;-351.1656,-967.8259;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;58;169.2448,-969.9567;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;448.8046,-968.816;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;62;662.1824,-966.5338;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;266.2355,-817.0546;Inherit;False;Property;_Multi;Multi;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;95;-3472.121,-1436.955;Inherit;False;Constant;_SpeedConstant;Speed Constant;15;0;Create;True;0;0;0;False;0;False;1,-2,2,-1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;98;-3471.807,-521.0233;Inherit;False;Constant;_SpeedConstant1;Speed Constant;15;0;Create;True;0;0;0;False;0;False;1,0,2,-1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;59;12.9199,-812.4904;Inherit;False;Property;_Pow;Pow;7;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-3734.102,-654.5089;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;25;-3028.162,-1375.66;Inherit;True;Property;_Pattern;Pattern;4;0;Create;True;0;0;0;False;0;False;db7f4ce1bb2d95d4e9b96b7dbe5a5fc8;db7f4ce1bb2d95d4e9b96b7dbe5a5fc8;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=51E226462AD71B04A044693C15EDEA58707375B4