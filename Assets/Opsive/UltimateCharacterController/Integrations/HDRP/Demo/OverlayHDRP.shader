...
Shader "Ultimate Character Controller/Demo/Overlay HDRP"
{
	Properties
	{
		...
		[ASEEnd]_OverlayTex("OverlayTex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_OverlayTex = packedInput.ase_texcoord5.xy * _OverlayTex_ST.xy + _OverlayTex_ST.zw;
				float4 tex2DNode16 = tex2D( _OverlayTex, uv_OverlayTex );
				
				surfaceDescription.Albedo = ( ( tex2D( _MainTex, uv_MainTex ) * ( 1.0 - tex2DNode16.a ) ) + ( tex2DNode16 * float4( 0,0,0,0 ) ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_OverlayTex = packedInput.ase_texcoord.xy * _OverlayTex_ST.xy + _OverlayTex_ST.zw;
				float4 tex2DNode16 = tex2D( _OverlayTex, uv_OverlayTex );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_OverlayTex = packedInput.ase_texcoord7.xy * _OverlayTex_ST.xy + _OverlayTex_ST.zw;
				float4 tex2DNode16 = tex2D( _OverlayTex, uv_OverlayTex );
...
/*ASEBEGIN
Version=18912
472;90;1066;919;813.3179;354.2517;1.013159;True;False
Node;AmplifyShaderEditor.RangedFloatNode;15;-608,110.5;Inherit;False;Constant;_Float0;Float 0;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-747,258.5;Inherit;True;Property;_OverlayTex;OverlayTex;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-705,-172.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;14;-398,179.5;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-376,339.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-366,-89.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-148.9737,-8.342094;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1E312E4E9C84E48B6CAC4E889F2FB408674D03A2